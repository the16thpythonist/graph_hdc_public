...
# ========= Molecule Conversion =========
# Canonical location: graph_hdc.domains.molecular.helpers
from graph_hdc.domains.molecular.helpers import (  # noqa: F401
...
# Keep ZINC_IDX_TO_ATOM available for any direct importers
from graph_hdc.domains.molecular.preprocessing import ZINC_IDX_TO_ATOM  # noqa: F401
...
def compute_hdc_distance(
    ...
    try:
        ...
        if original_x is not None:
            ...
            raw_x = onehot_to_raw_features(generated_data.x, feature_bins=ZINC_FEATURE_BINS)
...
def create_test_dummy_models(
    ...
    # Create minimal FlowEdgeDecoder
